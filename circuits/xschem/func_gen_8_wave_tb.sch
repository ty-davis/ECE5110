...
N 640 -70 840 -70 {lab=GND}
N 560 -90 820 -90 {lab=GND}
...
C {devices/sqwsource.sym} 690 -20 0 0 {name=V3 vhi=1.8 freq=0.25e6}
C {devices/sqwsource.sym} 770 0 0 0 {name=V4 vhi=1.8 freq=0.125e6}
...
C {devices/sqwsource.sym} 120 -80 0 0 {name=V6 vhi=1.8 freq=64e6}
C {devices/gnd.sym} 120 -30 0 0 {name=l15 lab=GND}
C {devices/lab_wire.sym} 790 -50 0 0 {name=p9 sig_type=std_logic lab=Wave}
C {devices/lab_wire.sym} 840 -30 0 0 {name=p10 sig_type=std_logic lab=Wave1}
C {devices/lab_wire.sym} 680 -110 0 0 {name=p11 sig_type=std_logic lab=Clk}
C {func_gen_8.sym} 1070 -40 0 0 {name=x1}
C {devices/gnd.sym} 560 -90 0 0 {name=l3 lab=GND}
C {devices/gnd.sym} 640 -70 0 0 {name=l4 lab=GND}
