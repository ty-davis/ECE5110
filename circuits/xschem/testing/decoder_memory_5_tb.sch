...
C {devices/gnd.sym} 480 110 1 1 {name=l8 lab=GND}
C {devices/gnd.sym} 510 70 1 1 {name=l9 lab=GND}
C {devices/gnd.sym} 510 30 1 1 {name=l10 lab=GND}
C {devices/lab_wire.sym} 1260 -110 0 0 {name=p13 sig_type=std_logic lab=Y0}
C {devices/vdd.sym} 60 -170 0 0 {name=l11 lab=VDD}
...
C {devices/sqwsource.sym} 270 -40 0 0 {name=V2 vhi=1.8 freq=0.5e6}
C {devices/sqwsource.sym} 340 -20 0 0 {name=V3 vhi=1.8 freq=0.25e6}
C {devices/sqwsource.sym} 420 0 0 0 {name=V4 vhi=1.8 freq=0.125e6}
C {devices/sqwsource.sym} 200 -60 0 0 {name=V5 vhi=1.8 freq=1e6}
C {devices/gnd.sym} 270 10 0 0 {name=l4 lab=GND}
C {devices/gnd.sym} 200 -10 0 0 {name=l5 lab=GND}
C {devices/gnd.sym} 340 30 0 0 {name=l6 lab=GND}
C {devices/gnd.sym} 420 50 0 0 {name=l7 lab=GND}
...
C {devices/sqwsource.sym} 120 -80 0 0 {name=V6 vhi=1.8 freq=2e6}
